...
<img class="avatar xs me-2" src="{{url('/')}}/assets/img/google.svg" alt="Image Description"> Sign in with Google </span>
</a>
...
<div class="col-12 text-center mt-4">
<span class="text-muted">Don't have an account yet? <a href="{{route('get.admin.register')}}">Sign up here</a></span>
</div>
</form>
