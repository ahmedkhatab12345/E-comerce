...
<div class="box-header">
    <h2 class="box-title text-center">Create Product</h2>
...
<div class="box-body" style="padding-right:30px;">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group col-md-8 d-none" id="child_cat_div" >
            ...
            <select  class="form-control" id="child_cat_id" name="subCategory_id">
            </select>
        </div>
        
        <div class="form-group col-md-8" style="margin-top :15px;">
            <label>Description</label>
            <input type="text"  id="price" name="description" class="form-control @error('description') is-invalid @enderror">
            @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group col-md-8" style="margin-top :15px;">
            <label>Price</label>
            <input type="text" name="price" id="textone" class="form-control value1 @error('price') is-invalid @enderror">
            @error('price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group col-md-8" style="display: none;" id="offer_id">
            ...
            <input type="text" name="valueOfferv" id="texttwo" class="form-control value2"  placeholder="enter value of Discount">
            
        </div>
        <div class="form-group col-md-8" style="display: none;" id="offer_id2">
            <label>Value Of Offer</label>
            <input type="text" name="valueOfferp" id="texttwo2" class="form-control value2" placeholder="enter persent (%) of Discount">
            
        </div>
        <div class="form-group col-md-8"  id="total_id">
        ...
        <div class="form-group" style="margin-top :15px;">
            <label>Photo</label>
            <input type="file" class="dropify  @error('photo') is-invalid @enderror" name="photo">
            @error('photo')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
