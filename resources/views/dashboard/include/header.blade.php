...
<a href="{{route('admin.dashbord')}}" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
...
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/xs/avatar5.jpg" alt="">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/xs/avatar6.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/xs/avatar1.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/xs/avatar3.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/xs/avatar4.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{url('/')}}/assets/img/xs/avatar7.jpg" alt="">
<div class="flex-fill ms-3">
...
<img class="avatar img-thumbnail rounded-circle shadow" src="{{asset('images/admins/'.auth()->user()->photo)}}" alt="">
</a>
<div class="dropdown-menu border-0 rounded-4 shadow p-0">
<div class="card border-0 w240">
<div class="card-body border-bottom d-flex">
<img class="avatar rounded-circle" src="{{asset('images/admins/'.auth()->user()->photo)}}" alt="">
<div class="flex-fill ms-3">
<h6 class="card-title mb-0">Allie Grater</h6>
<span class="text-muted"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1d7c717174787a6f7c69786f5d71687372337e7270">[email&#160;protected]</a></span>
</div>
</div>
<div class="list-group m-2 mb-3">
<a class="list-group-item list-group-item-action border-0" href="{{route('myprofile')}}"><i class="w30 fa fa-user"></i>My Profile</a>
