...
<span style="font-size: 15px; margin-right: 62px;" class="badge rounded-pill bg-danger">{{App\Models\Brand::count()}}</span>

<span class="arrow fa fa-angle-right ms-auto text-end"></span>
</a>

<ul class="sub-menu collapse" id="menu-Account">
<li><a class="ms-link" href="{{route('brands.index')}}">brands</a></li>
<li><a class="ms-link" href="{{ route('brands.create') }}">Add brand</a></li>
</ul>
</li>
...
<span style="font-size: 15px;  margin-right: 37px;" class="badge rounded-pill bg-danger">{{App\Models\Category::count()}}</span>

<span class="arrow fa fa-angle-right ms-auto text-end"></span>
</a>
<ul class="sub-menu collapse" id="menu-Applications">
<li><a class="ms-link" href="{{route('categories.dashboard')}}">Categories</a></li>
...
<span style="font-size: 15px; margin-right: 64px; text-align:center;" class="badge rounded-pill bg-danger">{{App\Models\Slider::count()}}</span>

<span class="arrow fa fa-angle-right ms-auto text-end"></span>
</a>

<ul class="sub-menu collapse" id="menu-Authentication">
<li><a class="ms-link" href="{{route('sliders.dashboard')}}">sliders</a></li>
<li><a class="ms-link" href="{{ route('admin.sliders.create') }}">Add slider</a></li>
...
<span style="font-size: 15px; margin-right:50px;" class="badge rounded-pill bg-danger">{{App\Models\Product::count()}}</span>
<span class="arrow fa fa-angle-right ms-auto text-end"></span>
</a>

<ul class="sub-menu collapse" id="menu_pages">
<li><a class="ms-link" href="{{route('products.dashboard')}}">Products</a></li>
<li><a class="ms-link" href="{{ route('admin.products.create') }}">Add product</a></li>
</ul>
</li>
<li><a class="ms-link btn btn-primary"  style="color:#333;font-size: 20px;" href="{{ route('admin.products.site') }}">Visit Site</a></li>
