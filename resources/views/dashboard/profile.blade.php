...
<div class="card">
<div class="card-body">
<form method="POST" class="form" id="formvalidation" action="{{route('profile.update')}}" enctype="multipart/form-data">
@csrf
<div class="row mb-3">
...
<div class="mb-3">
<form method="POST" class="form" id="formvalidation" action="{{route('password.update')}}">
@csrf
